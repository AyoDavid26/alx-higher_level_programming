...
class Rectangle:
    ...
    def __init__(self, width=0, height=0):
        """Initializing a newly created rectangle.
    ...
    def bigger_or_equal(rect_1, rect_2):
        """To return the rectangle with a greater area.

        Where:
        rect_1 (Rectangle) : First Rectangle
        rect_2 (Rectangle) : Second Rectangle.
        Raises:
        TypeError: If either of rect_1 or ect_2 is not a rectangle.
        """
